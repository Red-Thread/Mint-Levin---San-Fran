...
namespace XLMeeting1
{
    ...
    public sealed class Contract : IContract, IDisposable
    {
        ...
        public XLMeeting1.pageMain.IpageMain pageMain { get { return (XLMeeting1.pageMain.IpageMain)InternalpageMain; } }
        private XLMeeting1.pageMain.pageMain InternalpageMain { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalpageMain = new XLMeeting1.pageMain.pageMain(ComponentMediator, 1);
