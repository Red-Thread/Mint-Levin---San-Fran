...
namespace XLMeeting2
{
    ...
    public sealed class Contract : IContract, IDisposable
    {
        ...
        public XLMeeting2.pageMain.IpageMain pageMain { get { return (XLMeeting2.pageMain.IpageMain)InternalpageMain; } }
        private XLMeeting2.pageMain.pageMain InternalpageMain { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalpageMain = new XLMeeting2.pageMain.pageMain(ComponentMediator, 1);
