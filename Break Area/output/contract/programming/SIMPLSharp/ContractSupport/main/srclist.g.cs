...
namespace BreakArea.main
{
    ...
    public partial interface Isrclist : IsrclistByItem
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_5_Button_Selected(srclistBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_5_Button_Visible(srclistBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_5_Button_Text(srclistStringInputSigDelegate callback);
    }
    ...
    internal partial class srclist : Isrclist, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: main.srclist.Button5ItemPress
                /// Button5.ItemPress
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: main.srclist.Button5ItemSelected
                /// Button5.ItemSelected
                /// </summary>
                public const uint Button_5_Button_SelectedState = 8;
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: main.srclist.Button5Visible
                /// Button5.Visible
                /// </summary>
                public const uint Button_5_Button_VisibleState = 508;
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: main.srclist.Button5Text
                /// Button5.Text
                /// </summary>
        ...
        private Indexes GetIndexes(uint controlJoinId, uint join, eSigType eSigType)
        {
            if (controlJoinId == ControlJoinId &&
                ...
                join <= Joins.Booleans.Button_5_Button_PressEvent)
            {
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Selected(srclistBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Visible(srclistBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Text(srclistStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
