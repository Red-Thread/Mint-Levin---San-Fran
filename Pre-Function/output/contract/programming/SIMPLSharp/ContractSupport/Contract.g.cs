...
namespace PreFunction
{
    ...
    public sealed class Contract : IContract, IDisposable
    {
        ...
        public PreFunction.main.Imain main { get { return (PreFunction.main.Imain)Internalmain; } }
        private PreFunction.main.main Internalmain { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            Internalmain = new PreFunction.main.main(ComponentMediator, 1);
