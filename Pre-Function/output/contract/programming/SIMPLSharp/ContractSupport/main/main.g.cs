...
namespace PreFunction.main
{
    ...
    public partial interface Imain
    {
        ...
        /// </summary>
        PreFunction.main.Iheader header { get; }
    }
    ...
    internal partial class main : Imain, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            srclist = new PreFunction.main.srclist(ComponentMediator, 2);
            header = new PreFunction.main.header(ComponentMediator, 3);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((PreFunction.main.srclist)srclist).AddDevice(device);

            ((PreFunction.main.header)header).AddDevice(device);
        }
        ...
        ((PreFunction.main.srclist)srclist).RemoveDevice(device);

        ((PreFunction.main.header)header).RemoveDevice(device);
        }
        ...
        /// ComplexComponent src.list
        /// </summary>
        public PreFunction.main.Isrclist srclist { get; private set; }

        /// <summary>
        /// ComplexComponent header
        /// </summary>
        public PreFunction.main.Iheader header { get; private set; }
