...
namespace PreFunction.main
{
    ...
    public partial interface Iheader 
    {
        ...
        /// <summary>
        /// main.header.room.name$.Indirect Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void roomname_Indirect(headerStringInputSigDelegate callback);
    ...
    internal partial class header : Iheader, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: main.header.roomname.Indirect
                /// main.header.room.name$.Indirect
                /// </summary>
        ...
        /// <inheritdoc/>
        public void roomname_Indirect(headerStringInputSigDelegate callback)
        {
