...
namespace MintzLevin.pageMain.subCamera
{
    ...
    public partial interface IsubCamera
    {
        ...
        /// <summary>
        /// Event camAutoTrack.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camAutoTrack_PressEvent;

        /// <summary>
        /// Event camPreset_01.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camPreset_01_PressEvent;

        /// <summary>
        /// Event camPreset_02.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camPreset_02_PressEvent;

        /// <summary>
        /// Event camPrest_00.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camPrest_00_PressEvent;

        /// <summary>
        /// Event camZoomIn.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camZoomIn_PressEvent;

        /// <summary>
        /// Event CamZoomOut.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> CamZoomOut_PressEvent;

        /// <summary>
        /// camAutoTrack.Visibility Feedback
        /// </summary>
        ...
        /// <summary>
        /// camearAutoTrackTxt.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        ...
        /// <summary>
        /// camAutoTrack.Selected Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        ...
        /// <summary>
        /// camPreset_01.Selected Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        ...
        /// <summary>
        /// camPreset_02.Selected Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
    ...
    internal partial class subCamera : IsubCamera, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            cameraDPad = new MintzLevin.pageMain.subCamera.cameraDPad(ComponentMediator, 6);
        }
