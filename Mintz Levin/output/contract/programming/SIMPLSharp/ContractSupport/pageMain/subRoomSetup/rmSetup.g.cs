...
namespace MintzLevin.pageMain.subRoomSetup
{
    ...
    public partial interface IrmSetupByItem
    {
        ...
        /// <summary>
        /// Helper Button1.IconClass Feedback
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="serial">The <see cref="string"/> to update the panel.</param>
    ...
    public partial interface IrmSetup : IrmSetupByItem
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_4_Button_Selected(rmSetupBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_4_Button_Visible(rmSetupBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_Text(rmSetupStringInputSigDelegate callback);
        ...
        /// <summary>
        /// Button4.IconClass Feedback
        /// </summary>
        /// <param name="serial">The <see cref="string"/> to update the panel.</param>
        void Button_4_Button_IconClass(string serial);

        /// <summary>
        /// Button4.IconClass Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_4_Button_IconClass(rmSetupStringInputSigDelegate callback);
    }
    ...
    internal partial class rmSetup : IrmSetup, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: pageMain.subRoomSetup.rmSetup.Button4ItemPress
                /// Button4.ItemPress
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: pageMain.subRoomSetup.rmSetup.Button4ItemSelected
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: pageMain.subRoomSetup.rmSetup.Button4Visible
                /// Button4.Visible
                /// </summary>
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: pageMain.subRoomSetup.rmSetup.Button4Text
                /// Button4.Text
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: pageMain.subRoomSetup.rmSetup.Button4IconClass
                /// Button4.IconClass
                /// </summary>
                public const uint Button_4_Button_IconClassState = 504;
            }
        }
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Selected(rmSetupBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Visible(rmSetupBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_4_Button_IconClass(string serial)
        {
            Button_4_Button_IconClass((sig, component) => sig.StringValue = serial);
        }

        /// <inheritdoc/>
        public void Button_4_Button_IconClass(rmSetupStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].StringInput[Joins.Strings.Button_4_Button_IconClassState], this);
            }
        }
        ...
        /// <inheritdoc/>
        public void Button_4_Button_Text(rmSetupStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
