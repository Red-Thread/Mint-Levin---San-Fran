...
namespace MintzLevin.pageMain.Navigation
{
    ...
    public partial interface IItems_5_ 
    {
        ...
        /// <summary>
        /// Event pageMain.Navigation.Items[5].Button.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> Button_PressEvent;

        /// <summary>
        /// pageMain.Navigation.Items[5].Button.Selected Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_Selected(Items_5_BoolInputSigDelegate callback);
        ...
        /// <summary>
        /// pageMain.Navigation.Items[5].Button.Indirect Text Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_IndirectText(Items_5_StringInputSigDelegate callback);
        ...
        /// <summary>
        /// pageMain.Navigation.Items[5].Button.Icon Feedback
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void Button_Icon(Items_5_StringInputSigDelegate callback);
    ...
    internal partial class Items_5_ : IItems_5_, IDisposable
    {
        ...
        /// <inheritdoc/>
        public void Button_Selected(Items_5_BoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void Button_Icon(Items_5_StringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_IndirectText(Items_5_StringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
