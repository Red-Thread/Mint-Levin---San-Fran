...
namespace XLMeeting.pageMain.subCamera
{
    ...
    public partial interface IsubCamera
    {
        ...
        /// <summary>
        /// Event camPreset1.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camPreset1_PressEvent;

        /// <summary>
        /// Event camPreset2.Press (from panel to Control System)
        /// </summary>
        event EventHandler<UIEventArgs> camPreset2_PressEvent;

        /// <summary>
        /// Event camPreset3.Press (from panel to Control System)
        /// </summary>
        ...
        /// </summary>
        XLMeeting.pageMain.subCamera.IcameraDpad cameraDpad { get; }
    }
    ...
    internal partial class subCamera : IsubCamera, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            cameraDpad = new XLMeeting.pageMain.subCamera.cameraDpad(ComponentMediator, 9);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((XLMeeting.pageMain.subCamera.cameraDpad)cameraDpad).AddDevice(device);
        }
        ...
        ((XLMeeting.pageMain.subCamera.cameraDpad)cameraDpad).RemoveDevice(device);
        }
        ...
        /// ComplexComponent cameraDpad
        /// </summary>
        public XLMeeting.pageMain.subCamera.IcameraDpad cameraDpad { get; private set; }
