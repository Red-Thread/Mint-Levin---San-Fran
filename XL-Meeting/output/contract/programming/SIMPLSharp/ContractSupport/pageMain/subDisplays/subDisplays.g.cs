...
namespace XLMeeting.pageMain.subDisplays
{
    ...
    internal partial class subDisplays : IsubDisplays, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            displist1 = new XLMeeting.pageMain.subDisplays.displist1.displist1(ComponentMediator, 27);
            displaylist2 = new XLMeeting.pageMain.subDisplays.displaylist2.displaylist2(ComponentMediator, 32);
        }
