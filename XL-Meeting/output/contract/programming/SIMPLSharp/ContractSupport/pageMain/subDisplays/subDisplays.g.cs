...
namespace XLMeeting.pageMain.subDisplays
{
    ...
    public partial interface IsubDisplays
    {
        ...
        /// <summary>
        /// ComplexComponent disp.list1
        /// </summary>
        XLMeeting.pageMain.subDisplays.displist1.Idisplist1 displist1 { get; }

        /// <summary>
        /// ComplexComponent display.list2
        /// </summary>
        XLMeeting.pageMain.subDisplays.displaylist2.Idisplaylist2 displaylist2 { get; }
    }
    ...
    internal partial class subDisplays : IsubDisplays, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            displist1 = new XLMeeting.pageMain.subDisplays.displist1.displist1(ComponentMediator, 13);
            displaylist2 = new XLMeeting.pageMain.subDisplays.displaylist2.displaylist2(ComponentMediator, 14);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((XLMeeting.pageMain.subDisplays.displist1.displist1)displist1).AddDevice(device);

            ((XLMeeting.pageMain.subDisplays.displaylist2.displaylist2)displaylist2).AddDevice(device);
        }
        ...
        ((XLMeeting.pageMain.subDisplays.displist1.displist1)displist1).RemoveDevice(device);

        ((XLMeeting.pageMain.subDisplays.displaylist2.displaylist2)displaylist2).RemoveDevice(device);
        }
        ...
        /// ComplexComponent disp.list1
        /// </summary>
        public XLMeeting.pageMain.subDisplays.displist1.Idisplist1 displist1 { get; private set; }

        /// <summary>
        /// ComplexComponent display.list2
        /// </summary>
        public XLMeeting.pageMain.subDisplays.displaylist2.Idisplaylist2 displaylist2 { get; private set; }
