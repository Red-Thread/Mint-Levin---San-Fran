...
namespace XLMeeting.pageMain.subAudio
{
    ...
    public partial interface IsubAudio 
    {
        ...
        /// </summary>
        XLMeeting.pageMain.subAudio.faders.Ifaders faders { get; }
    }
    ...
    internal partial class subAudio : IsubAudio, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            faders = new XLMeeting.pageMain.subAudio.faders.faders(ComponentMediator, 3);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((XLMeeting.pageMain.subAudio.faders.faders)faders).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((XLMeeting.pageMain.subAudio.faders.faders)faders).RemoveDevice(device);
        }
        ...
        /// </summary>
        public XLMeeting.pageMain.subAudio.faders.Ifaders faders { get; private set; }
