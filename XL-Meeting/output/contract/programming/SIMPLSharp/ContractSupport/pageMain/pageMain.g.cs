...
namespace XLMeeting.pageMain
{
    ...
    internal partial class pageMain : IpageMain, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            subAudioEvent = new XLMeeting.pageMain.subAudioEvent.subAudioEvent(ComponentMediator, 2);
            subRouting = new XLMeeting.pageMain.subRouting.subRouting(ComponentMediator, 4);
            Navigation = new XLMeeting.pageMain.Navigation.Navigation(ComponentMediator, 7);
            subCamera = new XLMeeting.pageMain.subCamera.subCamera(ComponentMediator, 8);
            subShareSrc = new XLMeeting.pageMain.subShareSrc.subShareSrc(ComponentMediator, 10);
            subDisplays = new XLMeeting.pageMain.subDisplays.subDisplays(ComponentMediator, 12);
            subRoomSetup = new XLMeeting.pageMain.subRoomSetup.subRoomSetup(ComponentMediator, 15);
        }
