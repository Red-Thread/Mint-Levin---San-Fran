...
namespace XLMeeting
{
    ...
    public sealed class Contract : IContract, IDisposable
    {
        ...
        public XLMeeting.pageMain.IpageMain pageMain { get { return (XLMeeting.pageMain.IpageMain)InternalpageMain; } }
        private XLMeeting.pageMain.pageMain InternalpageMain { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalpageMain = new XLMeeting.pageMain.pageMain(ComponentMediator, 1);
